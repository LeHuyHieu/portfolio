...
export const PROJECTS = [
    {
        ...
        image_list: [
            '/assets/projects/screencapture-localhost-ecom-vue-1.png',
            '/assets/projects/screencapture-localhost-ecom-vue-2.png',
            '/assets/projects/screencapture-localhost-ecom-vue-3.png',
            '/assets/projects/screencapture-localhost-ecom-vue-4.png',
            '/assets/projects/screencapture-localhost-ecom-vue-5.png',
            '/assets/projects/screencapture-localhost-ecom-vue-6.png',
            '/assets/projects/screencapture-localhost-ecom-vue-7.png',
            '/assets/projects/screencapture-localhost-ecom-vue-8.png',
            '/assets/projects/screencapture-localhost-ecom-vue-9.png',
            '/assets/projects/screencapture-localhost-ecom-vue-10.png',
        ],
    ...
    },
    {
        ...
        image_list: [
            '/assets/projects/screencapture-localhost-ecom-angular-1.png',
            '/assets/projects/screencapture-localhost-ecom-angular-2.png',
            '/assets/projects/screencapture-localhost-ecom-angular-3.png',
            '/assets/projects/screencapture-localhost-ecom-angular-4.png',
            '/assets/projects/screencapture-localhost-ecom-angular-5.png',
            '/assets/projects/screencapture-localhost-ecom-angular-6.png',
            '/assets/projects/screencapture-localhost-ecom-angular-7.png',
        ],
        desc: "Display product details, display product list, add to cart, checkout, order status, register, login, CRUD products, ... ",
        main_features: [
            "Display Product Details: Allows users to view detailed information about a product such as images, descriptions, prices, ratings, and reviews from other users.",
    ...
    },
    {
        ...
        image_list: [
            '/assets/projects/screencapture-ecommerce-php-1.png',
            '/assets/projects/screencapture-ecommerce-php-2.png',
            '/assets/projects/screencapture-ecommerce-php-3.png',
            '/assets/projects/screencapture-ecommerce-php-4.png',
            '/assets/projects/screencapture-ecommerce-php-5.png',
            '/assets/projects/screencapture-ecommerce-php-6.png',
            '/assets/projects/screencapture-ecommerce-php-7.png',
            '/assets/projects/screencapture-ecommerce-php-8.png',
            '/assets/projects/screencapture-ecommerce-php-9.png',
            '/assets/projects/screencapture-ecommerce-php-10.png',
            '/assets/projects/screencapture-ecommerce-php-11.png',
            '/assets/projects/screencapture-ecommerce-php-12.png',
        ],
    ...
    },
    {
        ...
        image_list: [
            '/assets/projects/screencapture-new-local-1.png',
            '/assets/projects/screencapture-new-local-2.png',
            '/assets/projects/screencapture-new-local-3.png',
            '/assets/projects/screencapture-new-local-4.png',
            '/assets/projects/screencapture-new-local-5.png',
            '/assets/projects/screencapture-new-local-6.png',
            '/assets/projects/screencapture-new-local-7.png',
            '/assets/projects/screencapture-new-local-8.png',
        ],
