		...
		<LazyMotion features={domAnimation}>
			<section id="about" className="section">
				...
				<div className="pt-10 pb-16 max-w-5xl flex flex-col gap-3">
					...
					>
						<p>Hello, I'm Jack Lee, a web developer experienced in PHP, MySQL, HTML, CSS, and JavaScript. I graduated from Ho Chi Minh City College of Information Technology with a major in Information Technology.</p>
